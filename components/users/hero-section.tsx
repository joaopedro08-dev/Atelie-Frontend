...
export default function HeroSection() {
    ...
    return (
        <motion.section initial={"hidden"} animate={"visible"} variants={containerVariants} className="relative min-h-screen bg-background flex items-center justify-center">
            ...
            <div className="absolute inset-0 z-0 bg-linear-to-b from-background via-transparent to-background dark:opacity-80 opacity-60 pointer-events-none" />
