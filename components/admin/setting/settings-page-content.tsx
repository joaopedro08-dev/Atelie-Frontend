                ...
                <TabsContent value="profile" className="outline-none">
                    <motion.div layout className="rounded-xl border bg-card p-6 shadow-sm space-y-6 mt-4">
                        <div className="flex items-center gap-4">
                            <div className="h-16 w-16 rounded-full bg-primary/10 flex items-center justify-center border-2 border-primary/20 text-primary">
                        ...
                        <div className="grid gap-6 md:grid-cols-2">
                            ...
                            <div className="space-y-2 md:col-span-2">
                                <Label className="flex items-center gap-2 text-muted-foreground italic text-xs">
                    ...
                    <motion.div layout className="rounded-xl border bg-card p-6 shadow-sm space-y-6 mt-4">
                        ...
                        <div className="max-w-md space-y-4">
                            ...
                            <div className="space-y-2">
                                <div className="flex items-center justify-between">
                                    ...
                                    <div className="group relative flex items-center gap-1 cursor-help">
                                        ...
                                        <div className="absolute bottom-full right-0 mb-2 w-64 p-3 bg-popover border rounded-lg shadow-xl opacity-0 group-hover:opacity-100 transition-all pointer-events-none z-50">
                            ...
                            <Button 
                                ...
                                className="w-full md:w-auto text-destructive border-destructive hover:bg-destructive/10 transition-colors"
                            >
                                {isChangingPass ? (
